...
export interface IAccountClient {
    authenticate(authenticationRequest: AuthenticationRequest): Observable<FileResponse>;
    createAdminUser(command: CreateAdminUserCommand): Observable<FileResponse>;
    createCorporateUser(command: CreateCorporateUserCommand): Observable<FileResponse>;
    createHomeorOfficeUser(command: CreateHomeOrOfficeUserCommand): Observable<FileResponse>;
    creatStudentUser(command: CreateStudentUserCommand): Observable<FileResponse>;
}
...
export class AccountClient implements IAccountClient {
    ...
    createAdminUser(command: CreateAdminUserCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/users/admin";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateAdminUser(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    createCorporateUser(command: CreateCorporateUserCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/users/corporateCustomer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateCorporateUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateCorporateUser(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateCorporateUser(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    createHomeorOfficeUser(command: CreateHomeOrOfficeUserCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/users/homeOrOfficeCustomer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateHomeorOfficeUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateHomeorOfficeUser(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateHomeorOfficeUser(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    creatStudentUser(command: CreateStudentUserCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/users/studentCustomer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreatStudentUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreatStudentUser(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreatStudentUser(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CreateCorporateUserCommand implements ICreateCorporateUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
    ...
    constructor(data?: ICreateCorporateUserCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.companyPreferred = _data["companyPreferred"];
            this.shippingMethod = _data["shippingMethod"];
            this.fax = _data["fax"];
        }
    }

    static fromJS(data: any): CreateCorporateUserCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateCorporateUserCommand();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["companyPreferred"] = this.companyPreferred;
...
export interface ICreateCorporateUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
...
export class CreateHomeOrOfficeUserCommand implements ICreateHomeOrOfficeUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
    phoneNumber?: string;
    address?: string;
    hoCompanyName?: string | undefined;
    hoFax?: string | undefined;

    constructor(data?: ICreateHomeOrOfficeUserCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.phoneNumber = _data["phoneNumber"];
            this.address = _data["address"];
            this.hoCompanyName = _data["hoCompanyName"];
            this.hoFax = _data["hoFax"];
        }
    }

    static fromJS(data: any): CreateHomeOrOfficeUserCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateHomeOrOfficeUserCommand();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["phoneNumber"] = this.phoneNumber;
        data["address"] = this.address;
        data["hoCompanyName"] = this.hoCompanyName;
        data["hoFax"] = this.hoFax;
        return data; 
    }
}

export interface ICreateHomeOrOfficeUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
...
export class CreateStudentUserCommand implements ICreateStudentUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
    ...
    constructor(data?: ICreateStudentUserCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateStudentUserCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateStudentUserCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateStudentUserCommand {
    userName?: string;
    email?: string;
    customerType?: string;
    password?: string;
